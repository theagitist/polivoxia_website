...
- **/illustrations/** — Gallery of digital illustrations by Adri M.: watermarked (`polivoxia.ca`) pop-art portraits, line studies and abstract pieces, in a CSS-columns masonry grid with a vanilla-JS lightbox (arrows/Esc, no library). Image slugs and captions are anonymised (`portrait-N`, `abstract-N`, `sketch-1`). Also includes four Journeyways game pieces (`journeyways-1..4`, sourced from play.journeyways.ca, un-watermarked) tagged "Journeyways" and linking to the cards/tiles component pages. Fonts: Special Elite, Courier Prime, Lato. Homepage card thumbnail `img/illustrations.jpg` is a 2×2 montage (not a live screenshot).
- **/costarica/** — Redirect to costarica.polivoxia.com
- **/downloads/** — Main downloads index
- **/sitemap.xml** — Sitemap (home, she_came_down_from_the_mountains, the_somatic_ghost, the_ground_remains, stories_in_whispers, sujeto_del_inconsciente, ounces_stemmata, programa_convivir, illustrations, downloads)
